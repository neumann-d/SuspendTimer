...
const Timer = new Lang.Class({
	...
	_init: function(suspendFunction) {
		this._suspend = suspendFunction;
	...
	startTimer: function() {
		if (!this._timerId) {
		    ...
		    this._menuLabel.text = this._timerValue.toString() + ' ' + _("min till suspend");
		}
	},
	...
	_timerCallback: function() {
		...
		if (this._menuLabel && (secondsLeft%60 == 0)) {
			this._menuLabel.text = Math.floor(secondsLeft/60).toString()+' '+_("min till suspend");
		}
		if (secondsLeft > 0) {
			return true;
		}
